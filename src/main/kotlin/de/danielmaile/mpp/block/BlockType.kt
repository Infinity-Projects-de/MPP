...
enum class BlockType(
    ...
    POLISHED_OBSIDIAN(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    SMOOTH_OBSIDIAN(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_STONE(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    CRACKED_HELL_STONE(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_STONE_BRICKS(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    CRACKED_HELL_STONE_BRICKS(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    SMOOTH_HELL_STONE_BRICKS(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_DIAMOND_BLOCK(ToolType.PICKAXE, 70f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_DIAMOND_ORE(ToolType.PICKAXE, 60f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_DIRT(ToolType.SHOVEL, 1f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_GOLD_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_GRASS_BLOCK(ToolType.SHOVEL, 1.5f, Sound.BLOCK_GRASS_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_LOG(ToolType.PICKAXE, 3f, Sound.BLOCK_WOOD_PLACE, Sound.BLOCK_STONE_BREAK),
    HELL_OBSIDIAN(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    LAVA_STONE(ToolType.PICKAXE, 2f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    LAVA_STONE_BRICKS(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    ORANGE_HELL_LEAVES(ToolType.HOE, 0.3f, Sound.BLOCK_AZALEA_LEAVES_PLACE, Sound.BLOCK_AZALEA_LEAVES_BREAK),
    RED_HELL_LEAVES(ToolType.HOE, 0.3f, Sound.BLOCK_AZALEA_LEAVES_PLACE, Sound.BLOCK_AZALEA_LEAVES_BREAK),
    YELLOW_HELL_LEAVES(ToolType.HOE, 0.3f, Sound.BLOCK_AZALEA_LEAVES_PLACE, Sound.BLOCK_AZALEA_LEAVES_BREAK),
    PLATIN_BLOCK(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    PLATIN_ORE(ToolType.PICKAXE, 8f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    SILVER_BLOCK(ToolType.PICKAXE, 50f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    TITANIUM_BLOCK(ToolType.PICKAXE, 80f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    AETHER_LEAVES(ToolType.HOE, 0.3f, Sound.BLOCK_AZALEA_LEAVES_PLACE, Sound.BLOCK_AZALEA_LEAVES_BREAK),
    HELL_PLANKS(ToolType.AXE, 2f, Sound.BLOCK_WOOD_PLACE, Sound.BLOCK_WOOD_BREAK);
