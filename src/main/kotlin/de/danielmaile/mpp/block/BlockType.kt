...
enum class BlockType(
    ...
    ENDERITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    CRACKED_ENDERITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    ...
    AETHERIUM_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    TERMINITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_SILVER_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_TUNGSTEN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_LEAD_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_NIKOLITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_TIN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_BAUXITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_GALANA_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_IRIDIUM_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_PERIDOT_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    DEEPSLATE_ZINC_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_ZINC_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_TUNGSTEN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_LEAD_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_BAUXITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_RUBY_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_SAPPHIRE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    NETHER_TIN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_NIKOLITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_IRIDIUM_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_TUNGSTEN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_TIN_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_LEAD_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_BAUXITE_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_CINNEBAR_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK),
    END_GALANA_ORE(ToolType.PICKAXE, 5f, Sound.BLOCK_STONE_PLACE, Sound.BLOCK_STONE_BREAK);
