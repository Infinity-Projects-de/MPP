...
enum class Tools(
    ...
    GRAVITITE_AXE(ToolTier.GRAVITIE, ToolType.AXE),
    GRAVITITE_HOE(ToolTier.GRAVITIE, ToolType.HOE),
    GRAVITITE_PICKAXE(ToolTier.GRAVITIE, ToolType.PICKAXE),
    GRAVITITE_SHOVEL(ToolTier.GRAVITIE, ToolType.SHOVEL),
