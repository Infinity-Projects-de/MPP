...
enum class Recipes {
    ...
    AETHER_WOODEN_SWORD(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        null,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_STICK, null),
    AETHER_WOODEN_SWORD1(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        null, null,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_OAK_PLANKS, null, null,
    ...
    AETHER_WOODEN_SWORD2(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_STICK, null, null),
    AETHER_WOODEN_SWORD3(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        null,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
        ItemType.AETHER_STICK, null),
    AETHER_WOODEN_SWORD4(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        null, null,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
    ...
    AETHER_WOODEN_SWORD5(true,
        ItemType.AETHER_WOODEN_SWORD, 1,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
        ItemType.AETHER_BIRCH_PLANKS, null, null,
        ItemType.AETHER_STICK, null, null),
    AETHER_WOODEN_HOE(true,
        ItemType.AETHER_WOODEN_HOE, 1,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS, null, null,
        ItemType.AETHER_STICK, null, null,
        ItemType.AETHER_STICK, null),
    AETHER_WOODEN_HOE1(true,
        ItemType.AETHER_WOODEN_HOE, 1,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS, null,
        ItemType.AETHER_STICK, null, null,
        ItemType.AETHER_STICK, null, null),
    AETHER_WOODEN_HOE2(true,
        ItemType.AETHER_WOODEN_HOE, 1,
        null,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS, null,
    ...
    AETHER_WOODEN_PICKAXE(true,
        ItemType.AETHER_WOODEN_PICKAXE,
        1,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS, null,
    ...
    AETHER_WOODEN_AXE(true,
        ItemType.AETHER_WOODEN_AXE,
        1,
        ItemType.AETHER_OAK_PLANKS,
        ItemType.AETHER_OAK_PLANKS, null,
        ItemType.AETHER_OAK_PLANKS,
    ...
    AETHER_STONE_HOE(true,
        ItemType.AETHER_STONE_HOE,
        1,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE, null,
        ItemType.AETHER_STICK, null, null,
        ItemType.AETHER_STICK, null, null),
    AETHER_STONE_HOE1(true,
        ItemType.AETHER_STONE_HOE,
        1,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE, null, null,
        ItemType.AETHER_STICK, null, null,
        ItemType.AETHER_STICK, null),
    AETHER_STONE_HOE2(true,
        ItemType.AETHER_STONE_HOE,
        1, null,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE, null, null,
    ...
    AETHER_STONE_HOE3(true,
        ItemType.AETHER_STONE_HOE, 1,
        null,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE, null,
        ItemType.AETHER_STICK, null, null,
        ItemType.AETHER_STICK, null),
    AETHER_STONE_PICKAXE(true,
        ItemType.AETHER_STONE_PICKAXE, 1,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE,
        ItemType.AETHER_STONE, null,
        ItemType.AETHER_STICK, null, null,
