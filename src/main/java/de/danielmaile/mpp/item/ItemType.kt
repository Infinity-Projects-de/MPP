...
enum class ItemType(
    ...
    ZANITE_BOOTS(Material.DIAMOND_BOOTS, ArmorAttribute(3.45, 2.3, EquipmentSlot.FEET).toAttributeMap(), null),
    ZANITE_CHESTPLATE(Material.DIAMOND_CHESTPLATE, ArmorAttribute(9.2, 2.3, EquipmentSlot.CHEST).toAttributeMap(), null),
