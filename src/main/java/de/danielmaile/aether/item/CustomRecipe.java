...
public enum CustomRecipe
{
    ...
    GRAVITIT_HOE1(true, CustomItemType.GRAVITITE_HOE, 1,
    ...
    GRAVITIT_HOE2(true, CustomItemType.GRAVITITE_HOE, 1,
    ...
    GRAVITIT_HOE3(true, CustomItemType.GRAVITITE_HOE, 1,
    ...
    GRAVITIT_PICKAXE(true, CustomItemType.GRAVITITE_PICKAXE, 1,
    ...
    GRAVITIT_AXE1(true, CustomItemType.GRAVITITE_AXE, 1,
    ...
    GRAVITIT_HELMET(true, CustomItemType.GRAVITITE_HELMET, 1,
    ...
    GRAVITIT_CHESTPLATE(true, CustomItemType.GRAVITITE_CHESTPLATE, 1,
    ...
    GRAVITIT_LEGGINGS(true, CustomItemType.GRAVITITE_LEGGINGS, 1,
    ...
    GRAVITIT_BOOTS(true, CustomItemType.GRAVITITE_BOOTS, 1,
