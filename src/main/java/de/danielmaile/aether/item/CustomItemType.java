...
public enum CustomItemType
{
    ...
    SUNSTONE("Stein der Sonne", "Dieser besondere Stein besitzt die Kraft eine mächtige Waffe herzustellen.",
    ...
    SUN_SWORD("Sonnenschwert", "Das Schwert des Sonnengottes ist eine mächtige Waffe die jeden erzittern lässt.",
