...
public enum CustomItemType
{
    ...
    GRAVITITE_AXE(ChatColor.LIGHT_PURPLE + "Gravititaxt", null,
            2020, Material.NETHERITE_AXE),
    GRAVITITE_BOOTS(ChatColor.LIGHT_PURPLE + "Gravititschuhe", null,
            3012, Material.NETHERITE_BOOTS, new ArmorAttribute(3.9, 3.9, EquipmentSlot.FEET)),
    GRAVITITE_CHESTPLATE(ChatColor.LIGHT_PURPLE + "Gravititbrustplatte", null,
            3010, Material.NETHERITE_CHESTPLATE, new ArmorAttribute(10.4, 3.9, EquipmentSlot.CHEST)),
    GRAVITITE_HELMET(ChatColor.LIGHT_PURPLE + "Gravitithelm", null,
            3009, Material.NETHERITE_HELMET, new ArmorAttribute(3.9, 3.9, EquipmentSlot.HEAD)),
    GRAVITITE_HOE(ChatColor.LIGHT_PURPLE + "Gravititharke", null,
            2019, Material.NETHERITE_HOE),
    GRAVITITE_LEGGINGS(ChatColor.LIGHT_PURPLE + "Gravitithose", null,
            3011, Material.NETHERITE_LEGGINGS, new ArmorAttribute(7.8, 3.9, EquipmentSlot.LEGS)),
    GRAVITITE_ORE(ChatColor.LIGHT_PURPLE + "Gravititerz", null,
            4014, Material.ANCIENT_DEBRIS, Material.ANCIENT_DEBRIS),
    GRAVITITE_PICKAXE(ChatColor.LIGHT_PURPLE + "Gravititspitzhacke", null,
            2021, Material.NETHERITE_PICKAXE),
    GRAVITITE_PLATE(ChatColor.LIGHT_PURPLE + "Garavititplatte", "Platten so fest, das fast alles Abgewehrt werden kann.",
            1006, Material.NETHERITE_SCRAP),
    GRAVITITE_SHOVEL(ChatColor.LIGHT_PURPLE + "Gravititschaufel", null,
            2022, Material.NETHERITE_SHOVEL),
    GRAVITITE_SWORD("Gavititschwert", null,
    ...
    SUN_STONE(ChatColor.BOLD.toString() + ChatColor.GOLD + "Stein der Sonne", "Dieser besondere Stein besitzt die Kraft eine mächtige Waffe herzustellen.",
    ...
    VALKYRE_AXE(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Kampfaxt der Walküren", "Dies ist die Kampfaxt der Walküren. Sie zerteil alles was in den Weg kommt.",
            2014, Material.IRON_AXE),
    VALKYRE_BOOTS(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Stiefel der Walküre", "Die Stiefel der Walküren erlauben es dir, langsamer auf den Boden zu fallen.",
            3004, Material.IRON_BOOTS, new ArmorAttribute(3, 1, EquipmentSlot.FEET)),
    VALKYRE_LEGGINGS(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Beinschutz der Walküre", "Der Beinschutz der Walküren ist stabil und hält vieles aus.",
            3003, Material.IRON_LEGGINGS, new ArmorAttribute(7.5, 1, EquipmentSlot.LEGS)),
    VALKYRE_RING(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Heiligenschein der Walküre", "Der heilige Ring der Walküren. Er besitzt die Kraft dich zu verstärken.",
            3001, Material.IRON_HELMET, new ArmorAttribute(3, 1, EquipmentSlot.HEAD)),
    VALKYRE_SWORD(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Rache der Walküren", "Ein mächtiges Schwert welches Furcht und Angst hervorruft.",
            2003, Material.IRON_SWORD, new ToolAttribute(8, 1.6)),
    VALKYRE_WINGS(ChatColor.BOLD.toString() + ChatColor.YELLOW + "Walkürenflügel", "Mit den Walkürenflügeln kannst du durch den Himmel gleiten wie ein Engel.",
